...
"        value.y += 0.05;\n"+
"//    if (0.0 < is.y && is.y < 64.0 && 0.0 < is.x && is.x < 2.0 && 0.0 < is.z && is.z < 64.0) {\n"+
"//        value.x += 0.05;\n"+
"    }\n"+
...
"    gl_FragColor = vec4(div, prevPressure, obstacle, 0);\n"+
"}\n"+
"";
...
"}\n"+
"";
var obstacle_frag="precision mediump float;\n"+
"uniform sampler2D uPressureTexture;\n"+
"uniform vec4 uOption;\n"+
"uniform vec4 uInvResolution;\n"+
"varying vec2 vTextureCoord;\n"+
...
"    \n"+
"    if( abs(is.x - 32.0) < 5.0 && abs(is.y - 32.0) < 5.0 && abs(is.z - 32.0) < 5.0){\n"+
"    value.z = 1.0;\n"+
"    }else{\n"+
"    value.z = 0.0;}\n"+
"    gl_FragColor = vec4(value);\n"+
